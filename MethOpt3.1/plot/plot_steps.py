...
for i in range(0, len(points_z) - 1):
    ax.plot([points_x[i], points_x[i + 1]], [points_y[i], points_y[i + 1]], [points_z[i], points_z[i + 1]], color='r')

n = 200
for step in range(1, min(5, len(points))):
